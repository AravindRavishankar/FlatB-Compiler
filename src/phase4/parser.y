...
CSTATEMENTS  :  LABEL CSTATEMENTS   { $$=$2; } 
...
/* exp */
EXP : TERM   { $$=$1; }
	| EXP PLUS EXP  { $$=new AstBinaryExp($1,$3,BinaryOp::plus); }
	| EXP MINUS EXP { $$=new AstBinaryExp($1,$3,BinaryOp::minus); }
	| EXP MUL EXP { $$=new AstBinaryExp($1,$3,BinaryOp::mul); }
	| EXP DIV EXP { $$=new AstBinaryExp($1,$3,BinaryOp::dv); }
